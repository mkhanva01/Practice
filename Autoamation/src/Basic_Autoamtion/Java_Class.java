...
public class Java_Class {
	...
	public static void main(String[] args) {
		...
		 		~It allows users to get a proper report after testing, That way the user gets to know how many test cases passed/ failed/ skipped. Based on that, the user can fix and run those failed/ skipped test cases.
				...
				~InvocationCount: Invokes methods for number of times. (Performance testing)
				...
				~We can Create Test Suite using TestNG, Which means we can create a suit of test case which holds multiple testcases and can be running at once.
			...
			*/
			...
			/*
			 ...
			  ~It makes it esier to understand the objects, WebElements are written in plain English.
			  
			  
			 ...
			  
			  Encapsulation in Java is a JAVA mechanism mechanism of OOP concept (Object Oriented Programming) of wrapping the data (variables) and code acting on the data (methods) together as a single unit.
			...
			//What is By Method?
			//A: By is a method to locate element using their locator.
		...
		/*
		 ...
		 ~What is GitHub?
		 :Git is a Platform for code hosting for version control and collaboration between community.
		 It also works as source code repository.
